            ...
            <div className="space-y-6 lg:space-y-8">
              ...
              <div className={`flex flex-col sm:flex-row gap-4 justify-center items-center px-4 pt-2 transition-all duration-500 delay-400 ${
                ...
                <button 
                  ...
                  className="w-full sm:w-auto hero-btn text-primary-foreground min-w-[160px] transform transition-all duration-300 hover:scale-105"
                >
                ...
                <button 
                  ...
                  className="w-full sm:w-auto px-6 md:px-8 py-3 md:py-4 rounded-xl font-semibold bg-secondary hover:bg-secondary/80 text-secondary-foreground transition-all duration-300 border border-border min-w-[160px] transform hover:scale-105"
                >

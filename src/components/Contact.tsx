            ...
            >
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <input
                  ...
                  className="w-full px-4 py-3 border rounded-xl bg-input text-foreground"
                />
                <input
                  type="email"
                  name="email"
                ...
                <textarea
                  ...
                  className="w-full px-4 py-3 border rounded-xl bg-input text-foreground resize-none"
                />
                ...
                <div className="grid grid-cols-2 gap-4">
                  {socialLinks.map((social, index) => (
                    <a
                      ...
                      className="flex items-center justify-center p-4 bg-secondary rounded-xl transition-all duration-300"
                    >

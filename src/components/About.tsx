      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid lg:grid-cols-2 gap-8 md:gap-12 lg:gap-16 items-center">
            ...
            {/* Stats & Info */}
            <div
              className={`space-y-6 mt-8 lg:mt-0 transition-all duration-700 delay-400 ${
                isVisible
                  ? 'opacity-100 translate-x-0'
                  : 'opacity-0 translate-x-10'
              }`}
            >
              {/* Personal Info Cards — ALWAYS 2 columns */}
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="glass-card p-4 md:p-6 rounded-xl text-center">
                  <i className="fas fa-phone text-primary text-xl md:text-2xl mb-3"></i>
                  <h4 className="font-semibold text-foreground mb-1 text-sm md:text-base">
                    Phone
                  </h4>
                  <p className="text-muted-foreground text-xs md:text-sm">
                ...
                <div className="glass-card p-4 md:p-6 rounded-xl text-center">
                  <i className="fas fa-building text-primary text-xl md:text-2xl mb-3"></i>
                  <h4 className="font-semibold text-foreground mb-1 text-sm md:text-base">
                    Company
                  </h4>
                  <p className="text-muted-foreground text-xs md:text-sm">
                   Peculiar Technoogies
                  </p>
                </div>

                <div className="glass-card p-4 md:p-6 rounded-xl text-center">
                  <i className="fas fa-code text-primary text-xl md:text-2xl mb-3"></i>
                  <h4 className="font-semibold text-foreground mb-1 text-sm md:text-base">
                    Experience
                  </h4>
                  <p className="text-muted-foreground text-xs md:text-sm">
              ...
              <div className="glass-card p-8 rounded-2xl">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  To create digital solutions that not only meet business
                  objectives but also delight users through thoughtful design
                  and robust functionality. Every line of code and every pixel
                  matters in crafting experiences that truly resonate with
                  people.
                </p>
              </div>
            </div>

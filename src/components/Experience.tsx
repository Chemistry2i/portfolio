...
const Experience = () => {
  ...
  const experiences = [
    ...
    },
    {
      ...
      period: '2022 - 2023',
      description: 'Developed custom websites and web applications for local businesses. Built e-commerce platforms and management systems.',
    ...
    },
    {
      ...
      period: '2021 - 2022',
      description: 'Started my professional journey working on frontend development. Learned industry best practices and agile methodologies.',
